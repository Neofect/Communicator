...
public class MainActivity extends Activity {
    ...
    private void initScanner() {
        scanner = new DeviceScannerBuilder(getApplicationContext(), scannerListener)
                .addBluetoothType()
                .addUsbType(getSupportingProducts())
                .build();
    }
    ...
    public static List<Pair<Integer, Integer>> getSupportingProducts() {
        ...
        usbSupportedProducts.add(new Pair<>(UsbId.VENDOR_SILABS, UsbId.SILABS_CP2102));
        usbSupportedProducts.add(new Pair<>(UsbId.VENDOR_SILABS, UsbId.SILABS_CP2105));
        usbSupportedProducts.add(new Pair<>(UsbId.VENDOR_SILABS, UsbId.SILABS_CP2108));
        usbSupportedProducts.add(new Pair<>(UsbId.VENDOR_SILABS, 0xea80));
