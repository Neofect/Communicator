...
class NeofectCdcAcmSerialDriver extends NeofectUsbSerialDriver {
    ...
    public UsbEndpoint[] open() throws IOException {
        ...
        //rst[0]: readEndPt
        //rst[1]: writeEndPt
        CdcAcmSerialPort cdcPort = (CdcAcmSerialPort) mPort;
        cdcPort.open(connection);

        endpoints[0] = cdcPort.mReadEndpoint;
        endpoints[1] = cdcPort.mWriteEndpoint;
        return endpoints;
    }
